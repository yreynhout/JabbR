...
namespace JabbR.ContentProviders
{
    public class NerdDinnerContentProvider : CollapsibleContentProvider
    {
            ...
            if (!String.IsNullOrEmpty(strDinnerId) && Int32.TryParse(strDinnerId, out dinnerId))
            {
                return FetchDinner(dinnerId).Then(dinner =>
                {
                    if (dinner != null && dinner.d != null)
                    {
                        ...
                        {
                            Content = String.Format(NerdDinnerContentFormat,
                            dinner.d.Latitude,
                            dinner.d.Longitude,
                            dinner.d.Address,
                            String.Format(
                            NerdDinnerInfoContentFormat,
                            dinner.d.Title,
        ...
        {
            string url = String.Format(NerdDinnerODdataFeedServiceDinnerQueryFormat, dinnerId);
